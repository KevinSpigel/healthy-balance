import lentejas from '../../assets/productImages/lentejas.png';
import quinoa from '../../assets/productImages/quinoa.png';
import espinaca from '../../assets/productImages/espinaca.png';
import calabaza from '../../assets/productImages/calabaza.png';
import acelga from '../../assets/productImages/acelga.png';
import cebolla from '../../assets/productImages/cebolla.png';
import brocoli from '../../assets/productImages/brocoli.png';
import choclo from '../../assets/productImages/choclo.png';

export const productsDataBase = [
    { id: 1, name: "Hamburguesa Lentejas", imgProduct: lentejas, description: "Lentejas", price: "125", stock: 10, category: "Hamburguesas" },
